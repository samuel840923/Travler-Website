			...
			<%} %>
			 <div class='form-row'>
              <div class='col-md-4 form-group'>
                <button class='form-control btn btn-info submit-button' type='button' onclick="location.href = 'FlightInfo.jsp'">Back To Flight List</button>
              </div>
			  <div class='col-md-4 form-group'>
              ...
              <%
              	if (!type.equals("2") && accountId != null) {
              %>
	              <div class='col-md-4 form-group'>
